...
html_title = 'Runestone Peer Plus'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='PeerPlus'
...
shelf_section = "Misc"
description = "If you are looking for a home to create peer instruction questions this is the place."
